...
## 19:45 - `B_1945_OFFENER_STREIT`
Ort: `L_SPEISESAAL` | Sichtbarkeit: `public`
Beat: Elias konfrontiert die Gruppe offen mit Teilen des Dossiers.
...
## 20:15 - `B_2015_STROMFLACKERN`
Ort: `L_SALON` | Sichtbarkeit: `public`
Beat: Das Licht flackert, Notstrom startet, die Gruppe wird unruhig.
...
## 20:30 - `B_2030_GESTAENDNISFORDERUNG`
Ort: `L_ARBEITSZIMMER` | Sichtbarkeit: `private`
Beat: Elias verlangt nacheinander unterschriebene Schuldeingestaendnisse.
...
## 20:48 - `B_2048_MARCO_TECHNIKFENSTER`
Ort: `L_TECHNIKRAUM` | Sichtbarkeit: `private`
Beat: Marco begibt sich zum Notstrompanel.

| Clue | Runde | Polarity | Typ | Rel | Suspects | Motive | Beats | Kurzfassung |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `K_PHY_MARCO_TECHNIKRESET` - Notstrom-Reset im Technikraum | 2 | entlastend | physical | 3 | Marco Steiner (`C_MARCO_STEINER`) | `M_MARCO_1` - Marco Steiner (`C_MARCO_STEINER`) | `B_2048_MARCO_TECHNIKFENSTER` (20:48, `L_TECHNIKRAUM`), `B_2015_STROMFLACKERN` (20:15, `L_SALON`) | Technikspur stuetzt Marcos Erklaerung teilweise.; Der Eintrag beweist aber nicht seine Anwesenheit ueber das gesamte Fenster.; Das schafft gleichzeitige Entlastung und Restverdacht. |

## 20:50 - `B_2050_HELENE_SALONFENSTER`
Ort: `L_SALON` | Sichtbarkeit: `public`
Beat: Helene bleibt mit Unterlagen im Salon zurueck.
...
## 20:52 - `B_2052_LEONIE_MEDKITFENSTER`
Ort: `L_SCHLAFZIMMER_UNTEN` | Sichtbarkeit: `private`
Beat: Leonie sucht im unteren Schlafzimmer Material aus dem Medkit.
...
## 20:59 - `B_2059_GREGOR_EINGANGSFENSTER`
Ort: `L_EINGANGSBEREICH` | Sichtbarkeit: `public`
Beat: Gregor steht am Schluesselbrett und gibt vor, Empfang zu suchen.
...
## 21:03 - `B_2103_BEWEGUNG_IM_GANG`
Ort: `L_OBERER_GANG` | Sichtbarkeit: `hidden`
Beat: Mehrere kurze Bewegungen im oberen Gang machen die Reihenfolge unklar.
...
## 21:05 - `B_2105_SCHUSS`
Ort: `L_ARBEITSZIMMER` | Sichtbarkeit: `hidden`
Beat: Ein einzelner Schuss faellt im Arbeitszimmer.
...
## 21:07 - `B_2107_LEICHENFUND`
Ort: `L_ARBEITSZIMMER` | Sichtbarkeit: `public`
Beat: Marco, Helene und Leonie finden Elias tot am Schreibtisch.
...
## Clues Mit Unbekannten Beat-IDs
